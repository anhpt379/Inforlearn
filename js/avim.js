...
function AVIM() {
  ...
  if (this.is_ie || (this.ver >= 1.3) || this.is_opera || this.isKHTML) {
    ...
    if (AVIMGlobalConfig.onOff == 0) 
      ...
      this.setMethod(AVIMGlobalConfig.method);
    this.setSpell(AVIMGlobalConfig.ckSpell);
    this.setDauCu(AVIMGlobalConfig.oldAccent);
  }
  else {
  ...
  this.mozGetText = function(obj) {
    ...
    while (1) {
      if (pos - g < 0) {
        ...
        if (this.notWord(v.substr(pos - g, 1))) {
          if (v.substr(pos - g, 1) == "\\") {
    ...
    if (this.DAWEO.indexOf(uk) < 0) {
      for (g = 1; g <= w.length; g++) {
        if ((uk != this.Z) && (s.indexOf(w.substr(w.length - g, 1)) >= 0)) {
          ...
          if (tE.indexOf(w.substr(w.length - g, 1)) >= 0) {
            for (h = 0; h < tEC.length; h++) {
  ...
  this.ie_replaceChar = function(w, pos, c) {
    ...
    if (this.whit && (this.up(w.substr(w.length - pos - 1, 1)) == 'U') && (pos != 1) && (this.up(w.substr(w.length - pos - 2, 1)) != 'Q')) {
      ...
      if ((this.up(this.unV(this.fcc(c))) == "Ơ") || (uc == "O")) {
        if (w.substr(w.length - pos - 1, 1) == 'u') 
          r = this.fcc(432);
        else 
          r = this.fcc(431);
      }
  ...
  this.replaceChar = function(o, pos, c) {
    ...
    if (!o.data) {
      ...
      if (r) 
        o.value = o.value.substr(0, pos - 1) + r + o.value.substr(pos);
  ...
  this.ifMoz = function(e) {
    ...
    if (typeof(cwi) == "undefined") 
      cwi = e.target.parentNode.parentNode.wi;
    ...
    avim.saveStr = "";
    if (avim.checkCode(code) || !avim.range.startOffset || (typeof(node.data) == 'undefined')) 
      return;
    node.sel = false;
    if (node.data) {
